...
##### print(get_answer("What was Peter Pandey's GPA in semester 1?"))3.70
##### print(get_answer("Peter Pandey GPA in firts semester"))
    # print(get_answer("Average gpa in third semester?"))
##### print(get_answer("How much is peter pandey's pending fees in the first semester?"))2000
##### print(get_answer("How much was peter pandey's due fees in the semester 1?"))
    # print(get_answer("What is the purpose of a balance sheet?"))

    # print(get_answer("How much Peter Pandey has paid so far in semester 1?"))
    # print(get_answer("What was the maximum GPA in the third semester?"))

    print(get_answer("Average marks of semester 3?"))
    print(get_answer("Average gpa in third semester?"))